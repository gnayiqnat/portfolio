...
export default function TableOfContents({ headings }) {
	...
	return (
		<nav className='mt-5 mb-8 border-2 rounded-md flex flex-col pr-2 p-5 md:pl-8 gap-3 bg-foreground/1'>
			<span>
			...
			<ul className='sm:pl-3 pr-4 flex flex-col gap-1'>
				{headings.map((heading) => (
					...
					>
						...
						<p
							...
							className={`hover:underline cursor-pointer text-lg sm:text-xl`}
						>
							{heading.text}
						</p>
					</li>
