...
function HeroCard(n) {
	...
	useEffect(() => {
		...
		currentHeight.current = document.getElementById(2).offsetHeight;
	...
	return (
		<motion.div
			...
			id={n.imageIndex}
			className={`font-bold flex ${n.type == 'small' ? 'flex-col' : 'flex-row'} justify-center items-center flex-nowrap gap-5 p-3 rounded-2xl text-black border-3 border-black cursor-pointer`}
			initial={{
				borderBottomWidth: 7,
				marginTop: 0,
				opacity: 1,
